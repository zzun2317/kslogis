        ...
        <form onSubmit={handleSignUp} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
          ...
          <div>
            ...
            <div style={{ position: 'relative', marginTop: '5px' }}>
              <input ref={passwordRef} type={showPassword ? "text" : "password"} placeholder="6자 이상 입력(숫자+영문)" value={password} onChange={(e) => { setPassword(e.target.value); setErrors(prev => ({ ...prev, password: false })); }} style={{ ...inputStyle, width: '100%', paddingRight: '40px', border: '2px solid', borderColor: errors.password ? '#dc3545' : (!isPasswordTouched ? '#ccc' : isPasswordValid ? '#28a745' : '#dc3545') }} />
